---
name: sf-gate-2
description: Advisory Gate 2 review before Build. Spawns tech-lead to review every story linked to the target brief; verdicts are appended per-story. Stories can individually pass while others need rework.
---

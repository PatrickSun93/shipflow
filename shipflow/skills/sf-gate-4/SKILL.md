---
name: sf-gate-4
description: Advisory Gate 4 review before Ship. Confirms every story under a brief is done, no Gate 3 verdict is still needs-changes, and the brief's Success section exists. Appends a Gate 4 verdict block to the brief.
---
